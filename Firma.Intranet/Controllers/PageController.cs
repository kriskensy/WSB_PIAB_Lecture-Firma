...
namespace Firma.Intranet.Controllers
{
    ...
    {
        //to jest obiekt odpowiedzialny za połączenie z DB
        ...
        public async Task<IActionResult> Create([Bind("IdPage,LinkTitle,Title,TextContent,Position")] Page page)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdPage,LinkTitle,Title,TextContent,Position")] Page page)
        {
            if (id != page.IdPage)
            {
                return NotFound();
